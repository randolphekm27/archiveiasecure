...
export default function LoginPage() {
  ...
  const { signIn, createOrganization, signInWithGoogle, resetPassword } = useAuth();
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Un email de reinitialisation a ete envoye a votre adresse.');
    } catch (err) {
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-slate-500 uppercase">Ou continuer avec</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 py-2.5 rounded-lg font-medium transition-all shadow-sm"
              >
